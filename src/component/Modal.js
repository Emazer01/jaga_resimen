...
import { handleForwardApel, handleLapApel, handleTambahAdmin, handleTambahDD, handleTambahJabatan, handleTambahKadet, handleTambahKadetBulk, handleTambahPengasuh } from "../function/Post"
import { handleAssignDinas, handleAssignJabatan, handleChangePassword, handleEditKadet } from "../function/Put"
                    ...
                    <form onSubmit={handleTambahAdmin}>
                        ...
                        <div className="modal-body px-lg-4">
                            <div className='py-1'>
                                ...
                                <div className="alert p-2 bg-danger d-none" id='tambah-admin-danger' role="alert">
                                    <strong>Gagal menyimpan!</strong>
                                    <span className='ps-2' id='login-danger-message'>periksa kembali data yang dimasukkan</span>
                                </div>
                                <div className="alert p-2 bg-success d-none" id='tambah-admin-success' role="alert">
                                    <strong>Berhasil menyimpan!</strong>
                                </div>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleTambahPengasuh}>
                        ...
                        <div className="modal-body px-lg-4">
                            <div className='py-1'>
                                ...
                                <div className="alert p-2 bg-danger d-none" id='tambah-pengasuh-danger' role="alert">
                                    <strong>Gagal menyimpan!</strong>
                                    <span className='ps-2' id='login-danger-message'>periksa kembali data yang dimasukkan</span>
                                </div>
                                <div className="alert p-2 bg-success d-none" id='tambah-pengasuh-success' role="alert">
                                    <strong>Berhasil menyimpan!</strong>
                                </div>
                            </div>
                        </div>
                                                                    ...
                                                                    <table className='w-100'>
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>Foto</td>
                                                                                <td>
                                                                                    <img src={foto.url} id={`display-foto-sakit-${sakit}`} className='border w-100 p-1' style={{ maxWidth: 300 }} />
                                                                    ...
                                                                    <table className='w-100'>
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>Foto</td>
                                                                                <td>
                                                                                    <img src={foto.url} id={`display-foto-izin-${izin}`} className='border w-100 p-1' style={{ maxWidth: 300 }} />
                                                                                    <input onChange={async (e) => {
                                                                                        let selectedFile = e.target.files[0]
                                                                                        await handleChangeFoto(selectedFile).then(x => {
                                                                                            console.log(x)
                            ...
                            <table className='w-100 table table-striped'>
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-end'>Hadir</td>
                                        <td className='text-end'>Sakit</td>
                                        <td className='text-end'>Izin</td>
                                        <td className='text-end'>Tanpa Keterangan</td>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        return (
                                            <tr key={eachSubordinates.subordinates_id}>
                                                ...
                                                {eachSubordinates.lap_apel.map(lap_apel => {
                                                    /*setKeterangan({
                                                        jumlah : keterangan.jumlah + Number(lap_apel.hadir) + Number(lap_apel.sakit) + Number(lap_apel.izin) + Number(lap_apel.tanpa_keterangan),
                                                        hadir : keterangan.hadir + Number(lap_apel.hadir),
                                                        sakit : keterangan.sakit + Number(lap_apel.sakit),
                                                        izin : keterangan.izin + Number(lap_apel.izin),
                                                        tanpa_keterangan : keterangan.tanpa_keterangan + Number(lap_apel.tanpa_keterangan)
                                                    })*/
